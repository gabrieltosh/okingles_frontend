    ...
    <div class="q-pa-md">
        <q-card class="my-card">
            <q-form @submit="handlePostBranchOffice" @reset="handleFormReset">
                <q-card-section>
                    <div class="text-subtitle1 text-primary">Editar Modulo</div>
  ...
  data () {
    return {
      data: {
        ...
        route: this.$route.params.data.route,
        icon: this.$route.params.data.icon,
        sub_module: this.$route.params.data.sub_module,
