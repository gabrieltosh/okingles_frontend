    ...
    <div>
        <div class="q-px-md q-pt-md q-gutter-sm">
            <q-breadcrumbs>
              ...
              <q-breadcrumbs-el label="Detalle"  :to="{name:'myclass.schedule', params: {schedule:this.$route.params.schedule ,questionnaire: this.$route.params.questionnaire}}" />
              <q-breadcrumbs-el label="Cuestionario"   />
            </q-breadcrumbs>
        </div>
        <div class="q-pa-md">
            <q-card class="my-card">
                ...
                <div class="row q-mx-lg q-pb-lg"  v-for="(question,index) in data.questions" :key="index">
                  ...
                  <div class="q-gutter-md col-12 q-pb-md" align="center">
                      <q-btn rounded label="Cerrar" color="primary" :to="{name:'myclass.schedule', params: {schedule: this.$route.params.schedule,questionnaire: this.$route.params.questionnaire}}"/>
