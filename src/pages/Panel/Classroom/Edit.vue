    ...
    <div>
        ...
        <div class="q-pa-md">
            <q-card class="my-card">
                <q-form @submit="handleUploadClassroom" @reset="handleFormReset">
                    <q-card-section>
                        <div class="text-subtitle1 text-primary">Editar Aula</div>
...
export default {
  ...
  methods: {
    handleUploadClassroom () {
      var url = '/panel/classroom/update/classroom'
