...
<div>
    <div class="q-px-md q-pt-md q-gutter-sm">
        <q-breadcrumbs>
            ...
            <q-breadcrumbs-el label="Estudiantes" icon="eva-grid-outline" :to="{name:'user.student.list'}" />
                                        ...
                                        <q-scroll-area style="height: 160px;">
                                            <div class="row">
                                                <div class="col-sm-6 q-pa-xs  col-xs-6 " align="center">
                                                    <div class="text-caption text-orange-9">Estudiante</div>
                                                    <div class="text-subtitle2 q-mb-xs">{{$route.params.student.name+' '+$route.params.student.lastname}}</div>
                                                </div>
                                                <div class="col-sm-6 q-pa-xs  col-xs-6 " align="center">
